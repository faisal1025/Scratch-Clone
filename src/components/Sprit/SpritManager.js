        ...
        <div className='flex items-center flex-wrap'>
            {
                sprites.map(sprite=>{
                    return(
                        <div className='flex p-3 border-4 border-t border-green-300 bg-green-300'>
                            <button onClick={()=>{dispatch(remove({id:sprite.Id}))}} className='border-4 border-red-300 bg-red-400 hover:bg-red-500 rounded'><Icon name="trash" size={15} className="text-grey-600 mx-2" /></button>
